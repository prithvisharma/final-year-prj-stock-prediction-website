...
/**
 * Lt generated by hbm2java
 */
@Entity
@Table(name = "lt", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Lt implements java.io.Serializable {
	...
	public Lt(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
