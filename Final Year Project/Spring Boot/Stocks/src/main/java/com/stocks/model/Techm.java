...
/**
 * Techm generated by hbm2java
 */
@Entity
@Table(name = "techm", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Techm implements java.io.Serializable {
	...
	public Techm(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
