...
/**
 * Icicibank generated by hbm2java
 */
@Entity
@Table(name = "icicibank", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Icicibank implements java.io.Serializable {
	...
	public Icicibank(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
