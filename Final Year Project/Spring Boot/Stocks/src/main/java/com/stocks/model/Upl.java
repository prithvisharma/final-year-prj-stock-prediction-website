...
/**
 * Upl generated by hbm2java
 */
@Entity
@Table(name = "upl", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Upl implements java.io.Serializable {
	...
	public Upl(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
