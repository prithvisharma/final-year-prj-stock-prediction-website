...
/**
 * Reliance generated by hbm2java
 */
@Entity
@Table(name = "reliance", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Reliance implements java.io.Serializable {
	...
	public Reliance(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
