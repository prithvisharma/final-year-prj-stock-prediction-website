...
/**
 * Hdfc generated by hbm2java
 */
@Entity
@Table(name = "hdfc", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Hdfc implements java.io.Serializable {
	...
	public Hdfc(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
