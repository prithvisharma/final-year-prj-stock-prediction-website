...
/**
 * Infy generated by hbm2java
 */
@Entity
@Table(name = "infy", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Infy implements java.io.Serializable {
	...
	public Infy(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
