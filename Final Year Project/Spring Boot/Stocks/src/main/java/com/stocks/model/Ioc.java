...
/**
 * Ioc generated by hbm2java
 */
@Entity
@Table(name = "ioc", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Ioc implements java.io.Serializable {
	...
	public Ioc(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
