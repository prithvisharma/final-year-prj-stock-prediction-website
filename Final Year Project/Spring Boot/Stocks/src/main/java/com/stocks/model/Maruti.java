...
/**
 * Maruti generated by hbm2java
 */
@Entity
@Table(name = "maruti", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Maruti implements java.io.Serializable {
	...
	public Maruti(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
