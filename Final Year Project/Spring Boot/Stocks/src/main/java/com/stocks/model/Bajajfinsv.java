...
/**
 * Bajajfinsv generated by hbm2java
 */
@Entity
@Table(name = "bajajfinsv", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Bajajfinsv implements java.io.Serializable {
	...
	public Bajajfinsv(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
