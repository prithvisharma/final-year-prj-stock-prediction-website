...
/**
 * Coalindia generated by hbm2java
 */
@Entity
@Table(name = "coalindia", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Coalindia implements java.io.Serializable {
	...
	public Coalindia(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
