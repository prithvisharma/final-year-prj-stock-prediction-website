...
/**
 * Adaniports generated by hbm2java
 */
@Entity
@Table(name = "adaniports", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Adaniports implements java.io.Serializable {
	...
	public Adaniports(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
