...
/**
 * Mm generated by hbm2java
 */
@Entity
@Table(name = "mm", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Mm implements java.io.Serializable {
	...
	public Mm(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
