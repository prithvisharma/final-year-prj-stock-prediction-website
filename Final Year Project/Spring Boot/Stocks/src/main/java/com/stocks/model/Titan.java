...
/**
 * Titan generated by hbm2java
 */
@Entity
@Table(name = "titan", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Titan implements java.io.Serializable {
	...
	public Titan(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
