...
/**
 * Sbilife generated by hbm2java
 */
@Entity
@Table(name = "sbilife", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Sbilife implements java.io.Serializable {
	...
	public Sbilife(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
