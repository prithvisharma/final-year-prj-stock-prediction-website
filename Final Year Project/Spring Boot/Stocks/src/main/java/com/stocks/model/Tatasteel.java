...
/**
 * Tatasteel generated by hbm2java
 */
@Entity
@Table(name = "tatasteel", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Tatasteel implements java.io.Serializable {
	...
	public Tatasteel(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
