...
/**
 * Ntpc generated by hbm2java
 */
@Entity
@Table(name = "ntpc", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Ntpc implements java.io.Serializable {
	...
	public Ntpc(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
