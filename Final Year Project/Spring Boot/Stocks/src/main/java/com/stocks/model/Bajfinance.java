...
/**
 * Bajfinance generated by hbm2java
 */
@Entity
@Table(name = "bajfinance", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Bajfinance implements java.io.Serializable {
	...
	public Bajfinance(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
