...
/**
 * Bajajauto generated by hbm2java
 */
@Entity
@Table(name = "bajajauto", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Bajajauto implements java.io.Serializable {
	...
	public Bajajauto(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
