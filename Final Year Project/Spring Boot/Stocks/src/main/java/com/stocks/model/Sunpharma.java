...
/**
 * Sunpharma generated by hbm2java
 */
@Entity
@Table(name = "sunpharma", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Sunpharma implements java.io.Serializable {
	...
	public Sunpharma(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
