...
/**
 * Hdfclife generated by hbm2java
 */
@Entity
@Table(name = "hdfclife", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Hdfclife implements java.io.Serializable {
	...
	public Hdfclife(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
