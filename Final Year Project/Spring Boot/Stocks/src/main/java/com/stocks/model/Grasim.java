...
/**
 * Grasim generated by hbm2java
 */
@Entity
@Table(name = "grasim", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Grasim implements java.io.Serializable {
	...
	public Grasim(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
