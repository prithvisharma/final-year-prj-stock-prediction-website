...
/**
 * Asianpaint generated by hbm2java
 */
@Entity
@Table(name = "asianpaint", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Asianpaint implements java.io.Serializable {
	...
	public Asianpaint(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
