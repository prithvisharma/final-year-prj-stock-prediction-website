...
/**
 * Drreddy generated by hbm2java
 */
@Entity
@Table(name = "drreddy", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Drreddy implements java.io.Serializable {
	...
	public Drreddy(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
