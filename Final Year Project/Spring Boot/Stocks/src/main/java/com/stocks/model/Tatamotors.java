...
/**
 * Tatamotors generated by hbm2java
 */
@Entity
@Table(name = "tatamotors", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Tatamotors implements java.io.Serializable {
	...
	public Tatamotors(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
