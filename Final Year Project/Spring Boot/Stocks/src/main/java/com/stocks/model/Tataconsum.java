...
/**
 * Tataconsum generated by hbm2java
 */
@Entity
@Table(name = "tataconsum", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Tataconsum implements java.io.Serializable {
	...
	public Tataconsum(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
