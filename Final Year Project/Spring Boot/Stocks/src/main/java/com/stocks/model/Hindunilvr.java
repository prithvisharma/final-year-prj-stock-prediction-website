...
/**
 * Hindunilvr generated by hbm2java
 */
@Entity
@Table(name = "hindunilvr", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Hindunilvr implements java.io.Serializable {
	...
	public Hindunilvr(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
