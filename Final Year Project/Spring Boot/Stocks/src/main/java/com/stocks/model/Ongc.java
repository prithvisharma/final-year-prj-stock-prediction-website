...
/**
 * Ongc generated by hbm2java
 */
@Entity
@Table(name = "ongc", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Ongc implements java.io.Serializable {
	...
	public Ongc(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
