 ...
 */
@Entity
@Table(name = "sbin", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Sbin implements java.io.Serializable {
	...
	public Sbin(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
