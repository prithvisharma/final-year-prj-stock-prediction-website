...
/**
 * Nestleind generated by hbm2java
 */
@Entity
@Table(name = "nestleind", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Nestleind implements java.io.Serializable {
	...
	public Nestleind(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
