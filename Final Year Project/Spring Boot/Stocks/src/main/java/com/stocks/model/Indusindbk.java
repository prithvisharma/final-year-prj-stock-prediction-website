...
/**
 * Indusindbk generated by hbm2java
 */
@Entity
@Table(name = "indusindbk", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Indusindbk implements java.io.Serializable {
	...
	public Indusindbk(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
