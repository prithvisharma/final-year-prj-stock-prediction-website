...
/**
 * Kotakbank generated by hbm2java
 */
@Entity
@Table(name = "kotakbank", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Kotakbank implements java.io.Serializable {
	...
	public Kotakbank(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
