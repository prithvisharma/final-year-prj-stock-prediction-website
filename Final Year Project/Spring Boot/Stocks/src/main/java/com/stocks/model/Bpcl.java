...
/**
 * Bpcl generated by hbm2java
 */
@Entity
@Table(name = "bpcl", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Bpcl implements java.io.Serializable {
	...
	public Bpcl(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
