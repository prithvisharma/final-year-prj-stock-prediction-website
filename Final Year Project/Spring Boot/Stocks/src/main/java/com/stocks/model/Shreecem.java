...
/**
 * Shreecem generated by hbm2java
 */
@Entity
@Table(name = "shreecem", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Shreecem implements java.io.Serializable {
	...
	public Shreecem(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
