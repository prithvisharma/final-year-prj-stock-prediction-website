...
/**
 * Hcltech generated by hbm2java
 */
@Entity
@Table(name = "hcltech", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Hcltech implements java.io.Serializable {
	...
	public Hcltech(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
