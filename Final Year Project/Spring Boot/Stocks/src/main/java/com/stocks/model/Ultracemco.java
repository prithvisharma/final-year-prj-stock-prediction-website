...
/**
 * Ultracemco generated by hbm2java
 */
@Entity
@Table(name = "ultracemco", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Ultracemco implements java.io.Serializable {
	...
	public Ultracemco(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
