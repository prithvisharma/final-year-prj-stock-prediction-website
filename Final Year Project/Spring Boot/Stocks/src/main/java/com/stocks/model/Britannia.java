...
/**
 * Britannia generated by hbm2java
 */
@Entity
@Table(name = "britannia", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Britannia implements java.io.Serializable {
	...
	public Britannia(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
