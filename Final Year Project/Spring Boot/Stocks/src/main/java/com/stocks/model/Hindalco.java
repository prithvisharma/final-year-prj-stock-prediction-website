...
/**
 * Hindalco generated by hbm2java
 */
@Entity
@Table(name = "hindalco", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Hindalco implements java.io.Serializable {
	...
	public Hindalco(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
