...
/**
 * Powergrid generated by hbm2java
 */
@Entity
@Table(name = "powergrid", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Powergrid implements java.io.Serializable {
	...
	public Powergrid(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
