...
/**
 * Axisbank generated by hbm2java
 */
@Entity
@Table(name = "axisbank", catalog = "stocksdata", uniqueConstraints = @UniqueConstraint(columnNames = "date"))
public class Axisbank implements java.io.Serializable {
	...
	public Axisbank(Date date, Double open, Double high, Double low, Double close, Double adjClose, Double volume,
			String SName) {
		this.date = date;
		this.open = open;
		this.high = high;
